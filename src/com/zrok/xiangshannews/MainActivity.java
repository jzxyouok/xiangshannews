...
import com.zrok.xiangshannews.activity.ChinnelActivity;
import com.zrok.xiangshannews.adapter.NewsFragmentPagerAdapter;
import com.zrok.xiangshannews.app.AppApplication;
import com.zrok.xiangshannews.bean.ChannelItem;
import com.zrok.xiangshannews.fragment.NewsFragment;
import com.zrok.xiangshannews.manager.ChannelManage;
import com.zrok.xiangshannews.tools.BaseTools;
import com.zrok.xiangshannews.view.ColumnHorizontalScrollView;
import com.zrok.xiangshannews.view.DrawerView;
...
public class MainActivity extends FragmentActivity{
	...
	private void initView() {
		...
		button_more_columns.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent_channel = new  Intent(getApplicationContext(), ChinnelActivity.class);
	...
	private void initColumnData() {
		userChannelList = ((ArrayList<ChannelItem>)ChannelManage.getManage(getApplicationContext()).getUserChannel());
	}
...
//			localTextView.setBackground(getResources().getDrawable(R.drawable.top_category_scroll_text_view_bg));
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		switch (requestCode) {
		case CHANNELREQUEST:
			 if (AppApplication.getApp().isChange) {
				//if(resultCode == CHANNELRESULT){
					setChangelView();
					AppApplication.getApp().isChange = false;
					for(int i =0,count=userChannelList.size();i<count;i++){
	                	ChannelItem bean = userChannelList.get(i);
	                	System.out.println("title:"+bean.getName());
	                }
