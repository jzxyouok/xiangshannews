package com.zrok.xiangshannews.app;
	...
	public DisplayImageOptions getOptions() {
		if (null == options) {
			options = new DisplayImageOptions.Builder()
					.showImageOnLoading(R.drawable.loading_on_img)
					.showImageForEmptyUri(R.drawable.loading_empty_img)
					.showImageOnFail(R.drawable.loading_fail_img)
